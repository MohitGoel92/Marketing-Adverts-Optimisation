...
# As expected, we see that each ad was selected approximately equally
...
# We observe that advert 5 has the highest total rewards, threfore we conclude that advert 5 is the best as it 
...
# Using the Thompon Sampling Algorithm, we see that the total reward usually around 2500. Unlike the UCB 
...
# Both charts resemble the same shape as the more the most popular advert is selected the more it will run,
# hence having the opportunity to receive a reward.
